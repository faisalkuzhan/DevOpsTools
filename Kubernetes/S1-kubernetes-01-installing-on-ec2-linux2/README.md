...
```bash
sudo kubeadm init --apiserver-advertise-address=172.31.24.133  --pod-network-cidr=10.244.0.0/16
```
...
sudo kubeadm join 172.31.19.226:6443 --token 9tx5zh.p6s4njz4f2lvzz1v \
...
- Open a  browser and check the `worker nod public ip:<NodePort>` of worker node to see Nginx Server is running. In this example, NodePort is 32276.
