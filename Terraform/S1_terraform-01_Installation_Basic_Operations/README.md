...
- Launch an EC2 instance using the Amazon Linux 2 AMI with security group allowing SSH, HHTP connections.
...
- Install yum-config-manager to manage your repositories.
  Depolarınızı yönetmek için yum-config-manager'ı yükleyin.
...
resource "aws_instance" "tf-ec2" {
  ami           = "ami-00c6177f250e07ec1"
  instance_type = "t2.micro"
  key_name      = "devops"    # write your pem file without .pem extension>
  tags = {
    "Name" = "tf-ec2"
  }
}
...
```
Burada -out=justs3 argümanı, Terraform'un oluşturduğu planın justs3 adlı bir dosyaya kaydedilmesini sağlar
