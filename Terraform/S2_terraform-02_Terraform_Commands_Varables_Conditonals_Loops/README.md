...
-local, başkaları tarafından değiştirlme ihityacı olmayacak ve main.tf içinde çok kullanılan değerler için kullanılır.  
- Make the changes in the `main.tf` file.
...
- Şart  Koşullu ifade, iki değerden birini seçmek
...
```
- sıfıra eşit degilse 2 tane oluştur  0 eşitse 3 tane oluştur
